...
apt install brightnessctl chromium-browser ffmpeg flameshot fzf gimp git gnome-tweaks gzip neovim nmap playerctl ripgrep scdoc screenkey stow sway tldr tmux tree wireshark zsh -y
